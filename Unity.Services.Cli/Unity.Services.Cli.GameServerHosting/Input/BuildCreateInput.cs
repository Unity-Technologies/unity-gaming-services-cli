...
class BuildCreateInput : CommonInput
{
    ...
    static void ValidateOsFamilyEnum(OptionResult result)
    {
        ...
        {
            result.ErrorMessage = $"Invalid option for --os-family. Did you mean one of the following? {string.Join(", ", Enum.GetNames<OsFamilyEnum>())}";
        }
    }
    ...
    static void ValidateBuildTypeEnum(OptionResult result)
    {
        ...
        {
            result.ErrorMessage = $"Invalid option for --type. Did you mean one of the following? {string.Join(", ", Enum.GetNames<BuildTypeEnum>())}";
        }
    }
}
