...
public class QueryCustomDataHandlerTests
{
    ...
    [Test]
    public async Task QueryDefaultCustomDataHandler_CallsLoadingIndicator()
    {
        Mock<ILoadingIndicator> mockLoadingIndicator = new Mock<ILoadingIndicator>();

        await QueryCustomDataHandler.QueryCustomDataAsync(null!, null!, null!, null!, mockLoadingIndicator.Object, CancellationToken.None);
    ...
    [Test]
    public void QueryCustomDataHandler_HandlesInputAndLogsOnSuccess()
    {
        ...
        Assert.DoesNotThrowAsync(async () => await QueryCustomDataHandler.QueryCustomDataAsync(input, m_MockUnityEnvironment.Object, m_MockCloudSaveDataService.Object, m_MockLogger.Object, default));
        TestsHelper.VerifyLoggerWasCalled(m_MockLogger, LogLevel.Critical, LoggerExtension.ResultEventId, Times.Once);
    }

    [Test]
    public void QueryCustomDataHandler_MissingBodyThrowsException()
    {
        var input = new QueryDataInput();
        Assert.ThrowsAsync<CliException>(async () => await QueryCustomDataHandler.QueryCustomDataAsync(input, m_MockUnityEnvironment.Object, m_MockCloudSaveDataService.Object, m_MockLogger.Object, default));
    }
}
