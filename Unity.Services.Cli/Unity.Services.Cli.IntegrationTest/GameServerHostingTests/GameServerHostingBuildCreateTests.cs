...
{
    const string k_BuildCreateCommand = "mh build create --name test-build --os-family linux --type CONTAINER";

    [Test]
    [Category("mh")]
    [Category("mh build")]
    [Category("mh build create")]
    ...
    {
        await GetFullySetCli()
            .Command("mh build create --os-family linux --type CONTAINER")
    ...
    {
        await GetFullySetCli()
            .Command("mh build create --name test-build --type CONTAINER")
            .AssertExitCode(ExitCode.HandledError)
    ...
    {
        await GetFullySetCli()
            .Command("mh build create --name test-build --os-family linux --type VM")
            .AssertExitCode(ExitCode.HandledError)
    ...
    {
        await GetFullySetCli()
            .Command("mh build create --name test-build --os-family linux")
            .AssertExitCode(ExitCode.HandledError)
    ...
    {
        await GetFullySetCli()
            .Command("mh build create --name test-build --os-family solaris --type CONTAINER")
            .AssertExitCode(ExitCode.HandledError)
