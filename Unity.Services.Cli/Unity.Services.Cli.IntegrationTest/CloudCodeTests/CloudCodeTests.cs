...
public class CloudCodeTests : UgsCliFixture
{
    ...
    const string k_CloudCodeOpenApiUrl
        = "https://services.docs.unity.com/specs/v1/636c6f75642d636f64652d61646d696e.yaml";
    ...
    public async Task SetUp()
    {
        ...
        var cloudCodeModels = await MappingModelUtils.ParseMappingModelsAsync(k_CloudCodeOpenApiUrl, new());
        cloudCodeModels = cloudCodeModels.Select(
            m => m.ConfigMappingPathWithKey(CommonKeys.ProjectIdKey, CommonKeys.ValidProjectId)
                ...
                .ConfigMappingPathWithKey("scripts", k_ValidScriptName));
    ...
    {
        const string expectedMsg = "Invalid script: The maximum number of statements executed have been reached.";
