...
class CloudCodeScriptsLoaderTests
{
    ...
    public async Task LoadScriptAsyncReturnScriptList()
    {
        ...
        var loadResult = await m_CodeScriptsLoader.LoadScriptsAsync(paths, "Cloud Code", ".js",
            m_MockCloudCodeInputParser.Object, m_MockCloudCodeScriptParser.Object, contents, CancellationToken.None);
    ...
    public void LoadScriptAsyncCatchScriptEvaluationException()
    {
        ...
        Assert.DoesNotThrowAsync(async () =>
            await m_CodeScriptsLoader.LoadScriptsAsync(paths, "Cloud Code", ".js",
                m_MockCloudCodeInputParser.Object, m_MockCloudCodeScriptParser.Object, contents,
