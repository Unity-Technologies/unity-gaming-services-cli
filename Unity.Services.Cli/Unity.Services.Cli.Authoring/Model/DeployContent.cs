...
[Serializable]
public class DeployContent : IDeploymentItem, ITypedItem
{
    /// <summary>
    ...
    public DeployContent(string name, string type, string path, float progress = 0, DeploymentStatus? status= null)
    {
        Name = name;
        Type = type;
        Path = path;
